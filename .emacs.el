...
(keymap-global-set "s-r"     'window-configuration-to-register)
(keymap-global-set "s-y"     'jump-to-register)
...
(keymap-global-set "s-c"     'winner-undo)
(keymap-global-set "s-v"     'winner-redo)
