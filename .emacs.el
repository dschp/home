...
(keymap-global-set "C-q 2"   'my/split-window-below)
(keymap-global-set "C-q C-2" 'my/split-window-below)
(keymap-global-set "C-q 3"   'my/split-window-right)
(keymap-global-set "C-q C-3" 'my/split-window-right)
...
(keymap-global-set "s-s"     'my/split-window-below)
(keymap-global-set "s-d"     'my/split-window-right)
